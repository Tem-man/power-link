...
<template>
  <div class="page-wrapper">
    ...
    <div class="toolbar">
      <div class="toolbar-item primary" @click="toggleDropdown">
      ...
      <div class="toolbar-item" @click="saveData">Save</div>
    </div>

    <!-- Source Code Button -->
    <SourceCode
      href="https://github.com/Tem-man/power-link/blob/main/examples/flow-examples/src/view/AddFlowNode/index.vue"
    />
...
const presetNodes = [
  {
    ...
    dotPositions: 'both',
    style: 'node-primary',
    info: { name: 'Task', desc: 'A task node' },
  },
  {
    type: 'event',
    label: 'Event Node',
    dotPositions: 'both',
    style: 'node-success',
    info: { name: 'Event', desc: 'An event node' },
  },
  {
    type: 'gateway',
    label: 'Gateway Node',
    dotPositions: 'both',
    style: 'node-warning',
    info: { name: 'Gateway', desc: 'A gateway node' },
  },
  {
    type: 'llm',
    label: 'LLM',
  ...
  },
  {
    ...
    dotPositions: 'both',
    style: 'node-primary',
    info: { name: 'Knowledge', desc: 'A knowledge node' },
  },
  {
    type: 'search',
    label: 'Search',
    dotPositions: 'both',
    style: 'node-primary',
    info: { name: 'Search', desc: 'A search node' },
  },
  {
    type: 'database',
    label: 'Database',
    dotPositions: 'both',
    style: 'node-primary',
    info: { name: 'Database', desc: 'A database node' },
  },
  {
    type: 'output',
    label: 'Output',
    dotPositions: 'left',
    style: 'node-success',
    info: { name: 'Output', desc: 'A output node' },
  },
  {
    type: 'input',
    label: 'Input',
    dotPositions: 'right',
    style: 'node-success',
    info: { name: 'Input', desc: 'A input node' },
  },
  // 循环 分支
  {
    type: 'loop',
    ...
    dotPositions: 'both',
    style: 'node-warning',
    info: { name: 'Loop', desc: 'A loop node' },
  },
  {
    type: 'branch',
    label: 'Branch',
    dotPositions: 'both',
    style: 'node-warning',
    info: { name: 'Branch', desc: 'A branch node' },
  },
  {
    type: 'condition',
    label: 'Condition',
    dotPositions: 'both',
    style: 'node-warning',
    info: { name: 'Condition', desc: 'A condition node' },
  },
  {
    type: 'action',
    label: 'Action',
    dotPositions: 'both',
    style: 'node-primary',
    info: { name: 'Action', desc: 'A action node' },
  },
  {
    type: 'decision',
    label: 'Decision',
    dotPositions: 'both',
    style: 'node-warning',
    info: { name: 'Decision', desc: 'A decision node' },
  },
];
